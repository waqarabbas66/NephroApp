...
// import Recommendedtips from './Screens/Recommendedtips'
// import Dailytips from './Screens/Dailytips'

export default class DietScreenToo extends Component {
    render() {
...
// }
  ...
  // const DietTabNav = TabNavigator({
  //     Recommendedtips :
  //      {
  //         screen: Recommendedtips
  //       },
  //     Dailytips : 
  //     {
  //         screen: Dailytips
